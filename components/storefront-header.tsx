...
export function StorefrontHeader({ current = 'Cart' }: { current?: string }) {
  ...
  return <>
    ...
    <header className="relative flex h-16 items-center justify-between border-b border-[#eee]">
      ...
      <div className="flex items-center gap-4"><Search className="md:hidden" size={18} /><a href="/dashboard" aria-label="Shopping cart"><ShoppingCart size={18} /></a><CircleUserRound size={18} /></div>
    </header>
  </>
}
