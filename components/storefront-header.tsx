...
export function StorefrontHeader() {
  ...
  return <>
    <div className="flex h-8 w-full items-center justify-center bg-black px-3 text-center text-[10px] text-white">Sign up and get 20% off to your first order. <a href="/signup" className="ml-1 underline">Sign Up Now</a><button aria-label="Close promotion" className="absolute right-4 sm:right-8"><X size={12} /></button></div>
