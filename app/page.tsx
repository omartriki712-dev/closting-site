...
export default function HomePage() { return <StorefrontFrame>
  ...
  <section className="rounded-2xl bg-[#f1f1f1] p-6 sm:p-10"><h2 className="text-center text-2xl font-black tracking-[-1px]">BROWSE BY DRESS STYLE</h2><div className="mt-7 grid gap-3 sm:grid-cols-2"><a href="/category" className="relative h-32 overflow-hidden rounded-lg bg-white p-5 text-base font-bold sm:h-40">Casual<img src={styleImage} alt="Casual style" className="absolute right-0 top-0 h-full w-2/3 object-cover object-[20%_30%]" /></a><a href="/category" className="relative h-32 overflow-hidden rounded-lg bg-white p-5 text-base font-bold sm:h-40">Formal<img src={heroImage} alt="Formal style" className="absolute right-0 top-0 h-full w-2/3 object-cover object-[45%_50%]" /></a><a href="/category" className="relative h-32 overflow-hidden rounded-lg bg-white p-5 text-base font-bold sm:h-40">Party<img src={styleImage} alt="Party style" className="absolute right-0 top-0 h-full w-2/3 object-cover object-[66%_54%]" /></a><a href="/category" className="relative h-32 overflow-hidden rounded-lg bg-white p-5 text-base font-bold sm:h-40">Gym<img src={catalogImage} alt="Gym style" className="absolute right-0 top-0 h-full w-2/3 object-cover object-[85%_54%]" /></a></div></section>
  <ReviewCarousel />
  </StorefrontFrame> }
