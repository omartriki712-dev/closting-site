...
type Product = { name: string; price: number; oldPrice?: number; image: string; rating: string; reviews: number; badge?: string; color: string; brand: string }
...
function FilterPanel({ onClose, selectedColors, setSelectedColors, selectedBrands, setSelectedBrands }: { onClose?: () => void; selectedColors: string[]; setSelectedColors: (colors: string[]) => void; selectedBrands: string[]; setSelectedBrands: (brands: string[]) => void }) {
